...
public class AdapterListKandidatPenyelenggara extends BaseAdapter {
    private Activity activity;
    private Fragment fragment;
    private ArrayList data;
    private static LayoutInflater inflater = null;
    public Resources res;
    DataKandidatPenyelenggara tempValues = null;

    public AdapterListKandidatPenyelenggara(Activity a, ArrayList d, Resources resLocal) {
        activity = a;
        data = d;
        res = resLocal;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            vi = inflater.inflate(R.layout.list_penyelenggara_kandidat, null);
        ...
        if(data.size() <= 0){
            ...
            tempValues=null;
            tempValues = (DataKandidatPenyelenggara) data.get(position);
